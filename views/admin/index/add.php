...
<form action="<?php echo url("map-fig/index/add"); ?>" id="save_map_form" method="post">
	<?PHP echo $csrf; ?>
    <input type="hidden" value="" id="geo_json_str" name="pointers">
    <p>
        <label for="">Name</label> 
        <input type="text" name="name" value="<?php echo $mapfig->name; ?>">
    </p>
    <div class="mapfig_slider_container">
        <label for="">Width</label> 
        <input type="hidden" name="width" id="mapfig_width" value="<?php echo $mapfig->width; ?>">
        <div id="mapfig_width_slider" class="slider"></div> 
        <div id="mapfig_width_value"><?php echo $mapfig->width; ?></div>
    </div>
    <div class="mapfig_slider_container">
        <label for="">Height</label> 
        <input type="hidden" name="height" id="mapfig_height" value="<?php echo $mapfig->height; ?>">
        <div id="mapfig_height_slider" class="slider" style=""></div> 
        <div id="mapfig_height_value" style=""><?php echo $mapfig->height; ?></div>
    </div>    
    <div class="mapfig_slider_container">
        <label for="">Zoom</label> 
        <input type="hidden" name="zoom"  id="mapfig_zoom"  value="<?php echo $mapfig->zoom; ?>">
        <div id="mapfig_zoom_slider" class="slider"></div> 
        <div id="mapfig_zoom_value"><?php echo $mapfig->zoom; ?></div>
    </div>
